...
def populate():
    ...
    sp5 = add_sp(story, 5, sp2,  "Ooh la la! all boys are drooling at you.", "dev", "Go to the right", 10, "mid", None)

    sp6 = add_sp(story, 6, sp3,  "O dear! Be adventurous and atlest a little vigilant. You cant keep missing opportunities like these. Never mind better try love luck next time.", "dev", "You ignore", 10, "end", None)

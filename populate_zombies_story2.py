...
def populate():
    ...
    story = add_story("zombies on space", "stub description hahahaha")

    # # Level 1
    sp1 = add_sp(story, 1, None,  "You are on space when virual zombies start to attack you.", None, 10, "start")
